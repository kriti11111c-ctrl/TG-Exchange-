...
db.wallets.insertOne({
  user_id: userId,
  balances: {btc: 0.5, eth: 2.0, usdt: 5000, bnb: 0, xrp: 0, sol: 0},
  updated_at: new Date()
});
...
# Test market prices
curl -X GET "https://your-app.com/api/market/prices"

# Test trade endpoint
curl -X POST "https://your-app.com/api/trade" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"coin": "btc", "amount": 0.01, "trade_type": "buy"}'
```
